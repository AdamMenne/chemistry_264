...
# ╔═╡ 9713eb6d-8244-4c7f-b283-dbc059399405
nA = ox_mass/oxM_mass

# ╔═╡ 8ea874bc-1e0a-40b7-80c0-977266135ad5
cA = nA/0.2

# ╔═╡ bc27312f-7f04-4e26-a3bf-a68784e06f4b
vA = [0.89, 20.99, 21.23, 23.18, 24.97, 27.69, 30.82, 32.11, 35.01, 37.32, 39.29, 41.01, 42.23, 43.82, 45.04];

# ╔═╡ 4fcc5d38-7fdd-4c83-bebe-556aa4f1e71c
vB = [1.15, 23.49, 23.87, 26.15, 28.08, 31.01, 34.58, 35.95, 38.83, 41.49, 43.38, 45.49, 46.47, 48.01, 49.39];

# ╔═╡ b1b51e41-1a48-4592-bacd-50c0cd9039d0
vAB_all = [(vA[i] - vA[1], vB[i] - vB[1]) for i=2:length(vA)]
...
manifest_format = "2.0"
project_hash = "18a2b7c28d45d4ea8a433925e8b61d0d0ad234fe"
